import {
		...
		<List spacing={2} pl={2}>
		  {service.points.map((point, idx) => (
			<ListItem key={idx} fontSize="md" color="gray.600">
			  <ListIcon as={MdCheckCircle} color={service.color} aria-hidden="true" focusable="false" />
			  {point}
			</ListItem>
		  ))}
		</List>
  ...
  const services: Service[] = [
	{
	  ...
	  points: ["Live Interaction with PWDs", "Experiential Zones", "Immersive Learning Experience"],
	  bg: "green.100",
	  color: "green.400",
	},
	{
	  ...
	  points: ["Practice-Oriented Learning", "Real-World Scenarios", "Hands-On Communication Skills"],
	  bg: "purple.100",
	  color: "purple.400",
	},
	{
	  ...
	  points: ["Content Tailored for PWDs", "Real-Time Examples", "Self-Paced Flexibility"],
	  bg: "blue.100",
	  color: "blue.400",
	},
	{
	  ...
	  points: ["Accessible Curriculum Design", "Practice-Driven Training", "Conducted by Inclusive Experts"],
	  bg: "orange.100",
	  color: "orange.400",
	},
	{
	  ...
	  points: ["Interviews & HR Interactions", "Support in Trainings", "Events, Workshops & Meetings"],
	  bg: "teal.100",
	  color: "teal.400",
	},
	{
	  ...
	  points: ["Tailored Recruitment Model", "Onboarding with Job Coaches", "Train-and-Hire Strategy"],
	  bg: "red.100",
	  color: "red.400",
	},
  ];
  ...
  const Features = () => {
	...
	return (
	  <Box as="section" aria-labelledby="features-heading" bg="gray.50" py={20} px={[4, 6, 16]}>
		<VStack spacing={4} textAlign="center" mb={10}>
		  ...
		  <Text color="gray.500" maxW="600px" fontSize="lg">
			We provide holistic and inclusive training and support services to ensure accessibility,
			upskilling, and empowerment of persons with disabilities.
		  </Text>
		</VStack>
